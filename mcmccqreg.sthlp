...
{synopt:{cmd:e(f_mean)}}{txt}Average value of objective function (for retained draws){p_end}
{synopt:{cmd:e(f_max)}}{txt}Max. objective function value{p_end}
{synopt:{cmd:e(f_min)}}{txt}Min. objective function value{p_end}
